...
/*package*/ class Sensor_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_qb70eh_a() {
    ...
    editorCell.addEditorCell(createConstant_qb70eh_a0());
    editorCell.addEditorCell(createProperty_qb70eh_b0());
    editorCell.addEditorCell(createConstant_qb70eh_c0());
    editorCell.addEditorCell(createProperty_qb70eh_d0());
    return editorCell;
  }
  private EditorCell createConstant_qb70eh_a0() {
  ...
  private EditorCell createProperty_qb70eh_b0() {
  ...
  private EditorCell createConstant_qb70eh_c0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_qb70eh_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_qb70eh_d0() {
    CellProviderWithRole provider = new PropertyCellProvider(myNode, getEditorContext());
