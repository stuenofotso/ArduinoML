...
/*package*/ class Action_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_8bscln_a() {
    ...
    editorCell.addEditorCell(createProperty_8bscln_d0());
    return editorCell;
  }
      ...
      protected EditorCell createRefCell(EditorContext context, final SNode effectiveNode, SNode node) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new Action_EditorBuilder_a.Inline_Builder_8bscln_a1a(getEditorContext(), myNode, effectiveNode).createCell();
          }
        }, effectiveNode, "actuator");
  ...
  private EditorCell createProperty_8bscln_d0() {
    CellProviderWithRole provider = new PropertyCellProvider(myNode, getEditorContext());
