...
/*package*/ class Actuator_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_ik8pix_a() {
    ...
    editorCell.addEditorCell(createConstant_ik8pix_a0());
    editorCell.addEditorCell(createProperty_ik8pix_b0());
    editorCell.addEditorCell(createConstant_ik8pix_c0());
    editorCell.addEditorCell(createProperty_ik8pix_d0());
    return editorCell;
  }
  private EditorCell createConstant_ik8pix_a0() {
  ...
  private EditorCell createProperty_ik8pix_b0() {
  ...
  private EditorCell createConstant_ik8pix_c0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_ik8pix_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_ik8pix_d0() {
    CellProviderWithRole provider = new PropertyCellProvider(myNode, getEditorContext());
